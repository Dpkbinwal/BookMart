...
const Footer = () => {
    return (
        <>
            <div div className="  dark:bg-slate-900 dark:text-white max-w-screen-2xl">
                <hr/>
                <footer className="  dark:bg-slate-900 dark:text-white footer p-10 bg-base-200 text-base-content">
                ...
                <footer className=" dark:bg-slate-900 dark:text-white  footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
