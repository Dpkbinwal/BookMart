...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`max-w-screen-2xl md:fixed container mx-auto md:px-20 px-1 dark:bg-slate-900 dark:text-white  left-0 right-0 top-0 z-50 ${
        ...
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl  font-bold cursor-pointer">Book Mart</a>
          </div>
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className="  dark:bg-slate-900 dark:text-white input  px-3 py-5 border rounded-md flex items-center gap-2">
  ...
  ><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z"/></svg>
            ...
            <div className="">
             {
              authUser?<Logout/> : <div>
              <a className=" btn cursor-pointer text-sm bg-red-500 text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300"
